...
PYVER_TO_CHECK_OUTPUT = {
    "3.8": "⚠️ You are using Python 3.8 which has reached end-of-file! Please upgrade to a newer version of Python (EOL 2024-10-07)",
    "3.9": "✔️ You are using Python 3.9 which has security support for more than 0 years (EOL 2025-10-01)",
    "3.10": "✔️ You are using Python 3.10 which has security support for more than 1 years (EOL 2026-10-01)",
    "3.11": "✔️ You are using Python 3.11 which has security support for more than 2 years (EOL 2027-10-01)",
    "3.12": "🚀 You are using Python 3.12 which is actively maintained (bugfixes) and has security support for more than 3 years (EOL 2028-10-01)",
    "3.13": "🚀 You are using Python 3.13 which is actively maintained (bugfixes) and has security support for more than 4 years (EOL 2029-10-01)",
}


@pytest.fixture(scope="module")
def mock_rich_no_wrap():
    with mock.patch("pirel.cli.RICH_CONSOLE", Console(soft_wrap=True)):
        yield
